import {
  ...
  getFormByOrganizationAPI,
} from "../../common/common.js";

$(document).ready(function () {
    const idOrganization = localStorage.getItem("iduser");
    getData(getFormByOrganizationAPI, idOrganization);
});

var getData = function (getFormByOrganizationAPI, idOrganization) {
  getFormByOrganizationAPI = getFormByOrganizationAPI.replace("{organizationId}",idOrganization);
  // Gọi API để lấy dữ liệu
  $.ajax({
    url: getFormByOrganizationAPI, // Thay đổi với URL API thực tế
    method: "GET",
